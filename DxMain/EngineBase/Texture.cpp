...
//#include "Texture.h"
//
//TextureSample::TextureSample(UINT width, UINT height, std::wstring name):
...
//#endif
//
//		ThrowIfFailed(D3DCompileFromFile(GetAssetFullPath(L"texture.hlsl").c_str(), nullptr, nullptr, "VSMain", "vs_5_0", compileFlags, 0, &vertexShader, nullptr));
//		ThrowIfFailed(D3DCompileFromFile(GetAssetFullPath(L"texture.hlsl").c_str(), nullptr, nullptr, "PSMain", "ps_5_0", compileFlags, 0, &pixelShader, nullptr));
//
...
//	{
//		TextureVertex triangleVertices[] =
//		{
...
//
//		//copy data to the intermediate upload heap and the schedule a copy from the upload heap to the texture2d
...
//
//		//describle and create srv for the texture;
...
//	}
//
//	//close command list and excute it begin the initial gpu setup
...
//
//
//void TextureSample::PopulateCommandList()
//{
...
//}
//
//std::vector<UINT8> TextureSample::GenerateTextureData()
//{
