...
void LandAndWavesApp::BuildRootSignature()
{
	...
	md3dDevice->CreateRootSignature(0, SerilizedBlob->GetBufferPointer(), SerilizedBlob->GetBufferSize(), IID_PPV_ARGS(mRootSignature.GetAddressOf()));
...
void LandAndWavesApp::Draw(const GameTimer& gt)
{
	...
	DrawItems(mCommandList.Get(), mRitemLayer[(int)RenderLayer::Opaque]);
...
void LandAndWavesApp::DrawItems(ID3D12GraphicsCommandList* cmdList, const std::vector<LandWaveRenderItem *>& ritems)
{
