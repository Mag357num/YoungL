...
DxException::DxException(HRESULT hr, const std::wstring& functionname, const std::wstring& filename, int lineNumer)
	:ErrorCode(hr),
...
std::wstring DxException::ToString() const
{
	...
	return FunctionName + L"failed in" + Filename + L"; line " + std::to_wstring(LineNumer) + L"; error: " + msg;
}
